...
var PromiseWebSocketClient = /** @class */ (function (_super) {
    __extends(PromiseWebSocketClient, _super);
    function PromiseWebSocketClient(_a) {
    ...
    PromiseWebSocketClient.prototype.connect = function (_a) {
        var _this = this;
        ...
        return this._timer.timer(new Promise(function (resolve, reject) {
            if (_this.isConnected())
                return true;
            var uri = "ws://" + _this._address + ":" + _this._port;
            _this._socket = socket_io_client_1.io(uri);
    ...
    PromiseWebSocketClient.prototype.request = function (message, _a) {
        var _this = this;
    ...
    PromiseWebSocketClient.prototype.send = function (message, _a) {
        var _this = this;
        var _b = _a === void 0 ? {} : _a, _c = _b.timeout, timeout = _c === void 0 ? this._timer.timeout : _c;
        return this._timer.timer(new Promise(function (resolve, reject) {
            if (!_this.isConnected())
    ...
    PromiseWebSocketClient.prototype.close = function (_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.timeout, timeout = _c === void 0 ? this._timer.timeout : _c;
    ...
    PromiseWebSocketClient.prototype.isConnected = function () {
        var _a;
        return !!((_a = this._socket) === null || _a === void 0 ? void 0 : _a.connected);
    };
    PromiseWebSocketClient.prototype.setTimeout = function (timeout) {
        this._timer.timeout = timeout;
    };
    return PromiseWebSocketClient;
}(events_1.EventEmitter));
exports.PromiseWebSocketClient = PromiseWebSocketClient;
//# sourceMappingURL=PromiseWebSocketClient.js.map