...
exports.WebSocketClientTransport = exports.NotConnectedError = exports.RequestTimeoutError = exports.ConnectionTimeoutError = exports.TimeoutError = void 0;
var PromiseWebSocketClient_1 = require("./PromiseWebSocketClient");
...
var WebSocketClientTransport = /** @class */ (function (_super) {
    __extends(WebSocketClientTransport, _super);
    function WebSocketClientTransport(_a) {
        var address = _a.address, port = _a.port;
        var _this = _super.call(this, { address: address, port: port }) || this;
        ...
        _this.onrequest = function (message) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, this._onrpcHandler(message)];
        }); }); };
        ...
        _this._onrpcHandler = function (message) { return __awaiter(_this, void 0, void 0, function () {
            var rpcRequests;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rpcRequests = JSON.parse(message);
    ...
    WebSocketClientTransport.prototype.connect = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 3, , 5]);
                        return [4 /*yield*/, _super.prototype.connect.call(this, { timeout: timeout })];
                    case 1:
                        _c.sent();
                    ...
                    case 3:
                        e_1 = _c.sent();
                        return [4 /*yield*/, this.onerror(e_1)
                            // throw e
                        ];
                    case 4:
                        _c.sent();
    ...
    WebSocketClientTransport.prototype.request = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, _super.prototype.request.call(this, message)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        e_2 = _a.sent();
    ...
    WebSocketClientTransport.prototype.send = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, _super.prototype.send.call(this, message)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
    ...
    WebSocketClientTransport.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
}(PromiseWebSocketClient_1.PromiseWebSocketClient));
