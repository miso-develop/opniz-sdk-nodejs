...
var PromiseWebSocketServer_1 = require("./PromiseWebSocketServer");
// const dbg = (...v) => console.log(chalk.gray.bgYellowBright(getDateStr(), "[WebSocketServerTransport]", ...v)) // DEBUG:
var WebSocketServerTransport = /** @class */ (function (_super) {
    __extends(WebSocketServerTransport, _super);
    function WebSocketServerTransport(_a) {
        var port = _a.port;
        var _this = _super.call(this, { port: port }) || this;
    ...
    WebSocketServerTransport.prototype.connect = function (_a) {
    ...
    WebSocketServerTransport.prototype.request = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
}(PromiseWebSocketServer_1.PromiseWebSocketServer));
