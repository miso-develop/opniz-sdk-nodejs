...
var PromiseTcpServer = /** @class */ (function (_super) {
    __extends(PromiseTcpServer, _super);
    function PromiseTcpServer(port) {
    ...
    PromiseTcpServer.prototype.listen = function (_a) {
            ...
            return __generator(this, function (_d) {
                return [2 /*return*/, this._timer.timer(new Promise(function (resolve, reject) {
                        ...
                        _this.server = net_1.default.createServer(function (socket) {
                            _this.socket = socket;
                            _this.socket.on("data", function (data) { return __awaiter(_this, void 0, void 0, function () { var _a, _b; return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        _b = (_a = socket).write;
                                        return [4 /*yield*/, this.ondata(data)];
                        ...
                        _this.server.listen(_this.port, resolve);
                    }), { error: new TimeoutError_1.ListenTimeoutError(), timeout: timeout })];
            });
        });
    };
    PromiseTcpServer.prototype.close = function (_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.timeout, timeout = _c === void 0 ? this._timer.timeout : _c;
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_d) {
                return [2 /*return*/, this._timer.timer(new Promise(function (resolve, reject) {
                        ...
                        _this.server.close(function (error) { return error ? reject(error) : resolve(); });
                    }), { error: new TimeoutError_1.CloseTimeoutError(), timeout: timeout })];
            });
        });
    };
    PromiseTcpServer.prototype.isListening = function () {
        var _a;
        return !!((_a = this.server) === null || _a === void 0 ? void 0 : _a.listening);
    };
    return PromiseTcpServer;
}(events_1.EventEmitter));
exports.PromiseTcpServer = PromiseTcpServer;
//# sourceMappingURL=PromiseTcpServer.js.map